...
class HeaderViewHolder(val view: View) : RecyclerView.ViewHolder(view) {
    fun setValue(order:Order){
        ...
        view.txtTotal.text= App.resourses!!.getString(R.string.total_semi)+" "+order.total.toString()+" $"
        view.txtShipingFee.text=App.resourses!!.getString(R.string.shipping_fee_in_china_semi)+" "+order.auditShippingInChinaFeeInUsd.toString()+" $"
